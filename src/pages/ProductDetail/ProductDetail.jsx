...
import ProductQualityController from 'src/components/ProductQualityController/ProductQualityController'
          ...
          <S.ProductBriefing>
            ...
            <S.ProductMeta>
              ...
              <S.ProductPrice>
                ...
                <S.ProductPriceSale>d{formatMoney(product.price)}</S.ProductPriceSale>
                <S.ProductPriceSalePercent>
                  {rateSale(product.price_before_discount, product.price)} giảm
                </S.ProductPriceSalePercent>
              </S.ProductPrice>
              <S.ProductQuality>
                <S.ProductQualityTitle>Số Lượng</S.ProductQualityTitle>
                <S.ProductQualityController>
                  <ProductQualityController value={quality} max={product.quantity} onChange={handleChangeQuality} />
                </S.ProductQualityController>
                <S.AvailableProductQuality>{product.quantity} sản phẩm có sẵn</S.AvailableProductQuality>
